...
class mAtt_cas(nn.Module):
    def __init__(self, epochs):
        super().__init__()
        #FE
        # bs, 1, channel, sample
        self.conv1 = nn.Conv2d(1, 22, (32, 1), dtype=torch.double)
        self.Bn1 = nn.BatchNorm2d(22, dtype=torch.double)
        # bs, 56, 1, sample
        self.conv2 = nn.Conv2d(22, 16, (1, 64), padding=(0, 32), dtype=torch.double)
        self.Bn2   = nn.BatchNorm2d(16, dtype=torch.double)

import numpy as np
from Green_Kfold_measure import Green_Kfolder
...
def main(subjects,subtest,on_frame,recenter,window_size):
    ...
    print("Perform Grenn\n")
    kf = Green_Kfolder(10)
    kf.perform_Kfold(X_parent,Y_parent,domains_parent,labels_codes,codes,subjects,subtest,prefix,4,window_size)

...
class Green_Kfolder_ND():
    def __init__(self,n_fold,epochs=20,batch_size=64,method=["SS","DA","DG"],n_ch=8):
        self.epochs = epochs
    ...
    def DG_Kfold(self,X_parent,Y_parent,domains_parent,labels_codes,codes,subjects,subtest,prefix,n_class=5,window_size=0.25):
    ...
    def Normal_Kfold(self,X_parent,Y_parent,domains_parent,labels_codes,codes,subjects,subtest,prefix,n_class=5,window_size=0.25):
    ...
    def DA_Kfold(self,X_parent,Y_parent,domains_parent,labels_codes,codes,subjects,subtest,prefix,n_class=5,window_size=0.25):
